    ...
    return (
        <Card className="bg-card">
            <CardHeader>
                ...
                <CardDescription>
                    {t("PAGES.SETTINGS.APPEARANCE.SUB_TITLE")}
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Select defaultValue="en">
                        <SelectTrigger>
                            <SelectValue placeholder={t("PAGES.SETTINGS.APPEARANCE.FIELDS.LANGUAGE.PLACEHOLDER")} />
                        </SelectTrigger>
                        <SelectContent>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium">{t("PAGES.SETTINGS.APPEARANCE.FIELDS.THEME.OPTIONS.DARK")}</span>
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            ...
                            <span className="text-sm font-medium">{t("PAGES.SETTINGS.APPEARANCE.FIELDS.THEME.OPTIONS.LIGHT")}</span>
                        </button>
                        <button
                            type="button"
                            className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border transition-colors hover:border-primary/50 hover:bg-muted/50"
                        >
                            ...
                            <span className="text-sm font-medium">{t("PAGES.SETTINGS.APPEARANCE.FIELDS.THEME.OPTIONS.SYSTEM")}</span>
                        </button>
                    </div>
                    <p className="text-xs text-muted-foreground">
